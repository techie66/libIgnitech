...
void print_packet(unsigned char* r_buf, int start, int end) {
...
int main(int argc, char *argv[]) {
	...
	const unsigned char redirect88_96[102] = {0xb0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x60,0xd0};
	...
	while(!time_to_quit) {
		...
		if (select_result > 0) {
			...
			if (FD_ISSET(pts,&readset)) {
				...
				print_packet(r_buf,0,total_read);
				...
				if (total_read == packet_size) {
					...
					if ( r_buf[0] == 0x30 && r_buf[packet_size-2] == version && 
							r_buf[packet_size-1] == (0x30 ^ version ^ 0xFF) ) {
